            ...
            <div class="sidebar">
              ...
              <div class="widget-product-categories pt-5">
                ...
                <ul class="product-categories sidebar-list list-unstyled">
                  <li class="cat-item">
                    <a href="dogmain.do">전체</a>
                  </li>
                  <li class="cat-item">
                    <a href="dogfood.do">사료</a>
                  </li>
                  <li class="cat-item">
                    <a href="dogsnack.do">간식</a>
                  </li>
                  <li class="cat-item">
                    <a href="dogtoy.do">장난감</a>
                  </li>
                </ul>
              </div>
              <div class="widget-product-tags pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled brandcheck">
                  <li><input type='checkbox' name='dogtypeall' id='checkall' checked> 전체
                	</li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodbrand' value='오리젠' checked> 오리젠
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodbrand' value='지위픽' checked> 지위픽
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodbrand' value='인섹트도그' checked> 인섹트도그
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodbrand' value='로얄캐닌' checked> 로얄캐닌
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodbrand' value='나우' checked> 나우
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodbrand' value='스텔라앤츄이스' checked> 스텔라앤츄이스
                  </li>
                </ul>
              </div>
              <div class="widget-product-brands pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled typecheck">
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodtype' value='건식' checked> 건식
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogfoodtype' value='습식' checked> 습식
                  </li>
                </ul>
              </div>
              <div class="widget-price-filter pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled">
                 ...
                 <form method='get' action="catfood.do">
                    <input type='text' name='pricelow' class='price minprice'> ~ <input type='text' name='pricehigh' class='price maxprice'> <input type="button" value='검색' class='price' id='pricebtn'>
                 </form>
                  </li>
                </ul>
              </div>
 ...
 <div class="col-lg-3 col-sm-6 pb-3" data-aos="fade" data-aos-easing="ease-in" data-aos-duration="1600" data-aos-once="true">
  ...
  //상품목록 DB에서 받아오기
	...
	pnumchange();
	  ...
	  //전체체크
	    function allcheck(){
	    	...
	    	if(checklength==checkboxlength){
	    		$('input[name=dogtypeall]').prop('checked',true);
	    	} else $('input[name=dogtypeall]').prop('checked',false);
	    	if($('.typecheck input[name=dogfoodtype]:checked').legnth==0){
	    		$('.brandcheck input[name=dogfoodbrand]').prop('checked',false);
	    	}
	  ...
	  //타입 전체체크
	    $('input[name=dogtypeall]').click(function(){
	    	if($(this).is(':checked')){
	    ...
	    $('.typecheck input').change(function(){
	    	...
	    	if(param.cate4!=null || param.cate3!=null)
	    		listajax();
	    	else{
	    		$('.pdlist').empty();
	    		$('.pagenum').empty();
	    ...
	    function chbox(){
	    	var type = [];
	    	$('.typecheck input[name=dogfoodtype]:checked').each(function(){
	    		type.push($(this).val());
	    	});	
	    	var brand = [];
	    	$('.brandcheck input[name=dogfoodbrand]:checked').each(function(){
	    		brand.push($(this).val());
	    	});	
	    	if(type=="") {
	    		type=null;
