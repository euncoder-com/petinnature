            ...
            <div class="sidebar">
              ...
              <div class="widget-product-brands pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled typecheck">
                  ...
                  <li class="tags-item">
                  <input type='checkbox' name='catsnacktype' value='파우치' checked> 파우치
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='catsnacktype' value='저키_스틱' checked> 져키_스틱
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='catsnacktype' value='캣닢_그라스' checked> 캣닢_그라스
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='catsnacktype' value='건조간식' checked> 건조간식
                  </li>
                </ul>
              </div>
  ...
  <div class="col-lg-3 col-sm-6 pb-3" data-aos="fade" data-aos-easing="ease-in" data-aos-duration="1600" data-aos-once="true">
   ...
   function page(total){
	...
	pnumchange();
	    ...
	    function chbox(){
	    	var type = [];
	    	$('.typecheck input[name=catsnacktype]:checked').each(function(){
	    		type.push($(this).val());
	    	});		
	    	if(type=="") {
	    		type=null;
