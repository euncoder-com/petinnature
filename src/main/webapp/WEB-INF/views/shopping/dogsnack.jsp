            ...
            <div class="sidebar">
              ...
              <div class="widget-product-brands pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled typecheck">
                  ...
                  <li class="tags-item">
                  <input type='checkbox' name='dogsnacktype' value='껌' checked> 껌
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogsnacktype' value='사시미' checked> 사시미
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogsnacktype' value='저키_트릿' checked> 저키_트릿
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogsnacktype' value='건조간식' checked> 건조간식
                  </li>
                </ul>
              </div>
	...
	pnumchange();
	  ...
	  //타입 전체체크
	    $('input[name=dogtypeall]').click(function(){
	  	...
	  	//변경
	    //브랜드변경시
	    $('.tags-item input[type=checkbox]').change(function(){
	    	allcheck();
	    	chbox();
	    	param.page=1;
	    ...
	    function chbox(){
	    	var type = [];
	    	$('.typecheck input[name=dogsnacktype]:checked').each(function(){
	    		type.push($(this).val());
	    	});		
	    	if(type=="") {
	    		type=null;
