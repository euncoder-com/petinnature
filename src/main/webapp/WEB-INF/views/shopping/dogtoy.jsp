            ...
            <div class="sidebar">
              ...
              <div class="widget-product-brands pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled typecheck">
                  ...
                  <li class="tags-item">
                  <input type='checkbox' name='dogtoytype' value='봉제_천' checked> 봉제_천
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogtoytype' value='터그' checked> 터그
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='dogtoytype' value='원반_공' checked> 원반_공
                  </li>
                </ul>
              </div>
 ...
 //상품목록 DB에서 받아오기
   function listajax(){
	...
	pnumchange();
	    ...
	    function chbox(){
	    	var type = [];
	    	$('.typecheck input[name=dogtoytype]:checked').each(function(){
	    		type.push($(this).val());
	    	});		
	    	if(type=="") {
	    		type=null;
