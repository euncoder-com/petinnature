            ...
            <div class="sidebar">
              ...
              <div class="widget-product-brands pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled typecheck">
                  ...
                  <li class="tags-item">
                  <input type='checkbox' name='cattoytype' value='인형_쿠션_공' checked> 인형_쿠션_공
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='cattoytype' value='낚시_막대' checked> 낚시_막대
                  </li>
                  <li class="tags-item">
                  <input type='checkbox' name='cattoytype' value='자동' checked> 자동
                  </li>
                </ul>
              </div>
              <div class="widget-price-filter pt-3">
                ...
                <ul class="product-tags sidebar-list list-unstyled">
                  ...
                  <form method='get' action="catfood.do">
                    <input type='text' name='pricelow' class='minprice price'> ~ <input type='text' name='pricehigh' class='price maxprice'> <input type="button" value='검색' class='price' id='pricebtn'>
                    </form>
                  </li>
                </ul>
              </div>
  ...
  <div class="col-lg-3 col-sm-6 pb-3" data-aos="fade" data-aos-easing="ease-in" data-aos-duration="1600" data-aos-once="true">
   ...
   function page(total){
	...
	pnumchange();
	    ...
	    function chbox(){
	    	var type = [];
	    	$('.typecheck input[name=cattoytype]:checked').each(function(){
	    		type.push($(this).val());
	    	});		
	    	if(type=="") {
	    		type=null;
