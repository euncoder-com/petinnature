...
<body>
		...
		<div class="container">
			<div class="row">
				<main class="col-md-9">
					...
					<form name="frm" id='frm' method="post" action="writeqna.do">
					<table border=1 id="qnaWrite">
						<thead id='header'>
							<tr>
							...
							<td width=894px;>
							 ...
							 <option value="default">문의유형선택</option>
 ...
 %></li>
    ...
    function handleQnatypeChange() {
        var qnatype = document.getElementById('qnatype').value;
        var tbody = document.getElementById('tbdqna');
        var qnasubmit = document.getElementById('qnasubmit');
        ...
        switch (qnatype) {
            case '배송':
                tbody.innerHTML = '<tr><td align="center">주문번호</td><td><input type="text" name="orderNo"></td></tr><tr><td align="center">문의제목</td><td><input type="text" name="title" class="wide-input"></td></tr><tr class="content-height"><td align="center">문의내용</td><td><textarea name="content" class="wide-input qnacontent"></textarea></td></tr>';
                qnasubmit.innerHTML = '<input type="submit" name="submit" class="writebutton" value="문의작성"/>';
                break;
            case '결제':
                tbody.innerHTML = '<tr><td align="center">주문번호</td><td><input type="text" name="orderNo"></td></tr><tr><td align="center">문의제목</td><td><input type="text" name="title" class="wide-input"></td></tr><tr class="content-height"><td align="center">문의내용</td><td><textarea name="content" class="wide-input qnacontent"></textarea></td></tr>';
                qnasubmit.innerHTML = '<input type="submit" name="submit" class="writebutton" value="문의작성"/>';
            ...
            case '환불':
                ...
                break;
            case '상품상세문의':
                tbody.innerHTML = '<tr><td align="center">상품번호</td><td><input type="text" name="productNo"></td></tr><tr><td align="center">문의제목</td><td><input type="text" name="title" class="wide-input"></td></tr><tr class="content-height"><td align="center">문의내용</td><td><textarea name="content" class="wide-input qnacontent"></textarea></td></tr>';
                qnasubmit.innerHTML = '<input type="submit" name="submit" class="writebutton" value="문의작성"/>';
                break;
            default:
                break;
    ...
    document.getElementById('qnatype').addEventListener('change', handleQnatypeChange);
