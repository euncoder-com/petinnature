...
<body>
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" id="minus"
		...
		<div class="container">
			<div class="row">
				<main class="col-md-9">
					...
					<div class="row product-content product-store"></div>
					<form name="frm" id='frm' method="post" enctype="multipart/form-data" action="reviewWrite.do">
						<table border=1 id="reviewWrite">
							<thead id='header'>
								<tr>
									<td align="center" width=100px;>평점</td>
									<td width=894px;><select name="ReviewType" id="Reviewtype">
				...
				<aside class="col-md-3">
					<div class="sidebar">
						...
						<div class="widget-product-categories pt-0">
							<h5 class="widget-title text-decoration-underline text-uppercase">마이페이지</h5>
    ...
    // 문의유형 선택이 변경될 때마다 호출되는 함수
    function handleReviewtypeChange() {
        var Reviewtype = document.getElementById('Reviewtype').value;
        var tbody = document.getElementById('tbdreview');
        var reviewsubmit = document.getElementById('reviewsubmit');

        // 이전에 추가된 내용 초기화
        tbody.innerHTML = '';
        reviewsubmit.innerHTML ='';
		var rate = $("#Reviewtype").val();
			
        // 선택된 문의유형에 따라 다른 내용 추가
        switch (Reviewtype) {
            case '1':
                tbody.innerHTML = '<tr><input type="hidden" name="product_no" value="${param.productNo}"><input type="hidden" name="rate" value="'+rate+'"><td id = "pdname" align="center">상품이름</td><td><input type="text" name="orderNo" class="productName" value="${param.pdname}" readonly></td></tr><tr><td align="center">제목</td><td><input type="text" name="title" class="wide-input productTitle"></td></tr><tr><td align="center">이미지</td><td class="file-upload-cell"><input type="file" name="file" accept="image/*"><button type="button" class="dtb" onclick="clearFileInput(this)">삭제</button></td></tr><tr class="content-height"><td align="center">내용</td><td><textarea name="content" value="${param.content}" class="wide-input reviewcontent"></textarea></td></tr>';
                reviewsubmit.innerHTML = '<input type="submit" name="submit" class="writebutton" value="후기작성"/>';
                break;
            case '2':
            	tbody.innerHTML = '<tr><input type="hidden" name="product_no" value="${param.productNo}"><input type="hidden" name="rate" value="'+rate+'"><td id = "pdname" align="center">상품이름</td><td><input type="text" name="orderNo" class="productName" value="${param.pdname}" readonly></td></tr><tr><td align="center">제목</td><td><input type="text" name="title" class="wide-input productTitle"></td></tr><tr><td align="center">이미지</td><td class="file-upload-cell"><input type="file" name="file" accept="image/*"><button type="button" class="dtb" onclick="clearFileInput(this)">삭제</button></td></tr><tr><td align="center">내용</td><td><textarea name="content" value="${param.content}" class="wide-input reviewcontent"></textarea></td></tr>';
                reviewsubmit.innerHTML = '<input type="submit" name="submit" class="writebutton" value="후기작성"/>';;
                break;
            case '3':
            	tbody.innerHTML = '<tr><input type="hidden" name="product_no" value="${param.productNo}"><input type="hidden" name="rate" value="'+rate+'"><td id = "pdname" align="center">상품이름</td><td><input type="text" name="orderNo" class="productName" value="${param.pdname}" readonly></td></tr><tr><td align="center">제목</td><td><input type="text" name="title" class="wide-input productTitle"></td></tr><tr><td align="center">이미지</td><td class="file-upload-cell"><input type="file" name="file" accept="image/*"><button type="button" class="dtb" onclick="clearFileInput(this)">삭제</button></td></tr><tr><td align="center">내용</td><td><textarea name="content" value="${param.content}" class="wide-input reviewcontent"></textarea></td></tr>';
    ...
    document.getElementById('Reviewtype').addEventListener('change', handleReviewtypeChange);
