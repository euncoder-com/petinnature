  ...
  <symbol xmlns="http://www.w3.org/2000/svg" id="minus" viewBox="0 0 24 24">
    ...
    <div class="shopify-grid padding-large">
      <div class="container">
		...
		<td width="600" align="center">후기내용</td>	
		<td width="80" align="center">별점</td>
		<td width="140" align="center">작성일</td>
		<td width="120" align="center">후기삭제</td>
		</tr>
		</thead>
		<tbody id='tbd'>
		<form class= "frm" action='delete_review.do' method="post">
			<c:forEach items="${reviewList}" var='review'>
            <tr>
            	<td width="100" height="80" align="center">${review.product_no}</td>
            	<td width="250" height="80" align="center"><a href="../shopping/single-product.do?productNo=${review.product_no}"> ${review.product_name}</a></td>
            	<td width="600" height="80" align="center">${review.content}</td>
            	<td width="140" height="80" align="center">${review.rate}</td>
            	<td width="80" height="80" align="center">${review.rdate}</td>
            	<td>
            	<input type="hidden" name="review_no" value="${review.review_no}">
            	<button type="submit" class="deletbtn"  >삭제</button>
            ...
            <div class="sidebar">
              ...
              <div class="widget-product-categories pt-0">
                ...
                <ul class="product-categories sidebar-list list-unstyled">
                  <li class="cat-item">
                    <a href="mypage_memberinfo.do">회원정보</a>
                  </li>
                  <li class="cat-item">
                    <a href="mypage_orderlist.do">주문내역</a>
                  </li>
                  <li class="cat-item">
                    <a href="mypage_review.do">후기내역</a>
                  </li>
                  <li class="cat-item">
                    <a href="mypage_qna.do">문의내역</a>
                  </li>
                </ul>
              </div>
            </div>
