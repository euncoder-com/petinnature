		...
		<div class="container">
			<div class="row">
				<main class="col-md-9">
					...
					<table border=1 id="reviewlistTable">
						<thead id='header'>
							<tr>
								<td width="120" align="center">주문일자<br />[주문번호]
								</td>
								<td width="250" align="center">상품이름</td>
								<td width="80" align="center">수량</td>
								<td width="200" align="center">구매금액</td>
								<td width="140" align="center">주문처리상태</td>
								<td width="100" align="center"><a href=''>후기작성</a></td>
							</tr>
						</thead>
						<tbody id='tbd'>
							<c:forEach items="${orderList}" var='orderlist'>
								<tr>
									<td width="120" height="80" align="center">${orderlist.rdate}</br>
										<a href="order_cancel.do?order_no=${orderlist.order_no}"
										style="color: blue; text-decoration: underline;">[${orderlist.order_no}]</a></td>
									<td width="250" height="80" align="center">${orderlist.product_name}</td>
									<td width="80" height="80" align="center">${orderlist.cnt}</td>
									<td width="200" height="80" align="center">${orderlist.price}</td>
									<td width="140" height="80" align="center">${orderlist.orderstatus}</td>

									<td>

										<button type="submit" class="reviewbtn"
											onclick="location.href='./review_write.do?pdname=${orderlist.product_name}&productNo=${orderlist.product_no}'">후기작성</button>
									</td>
								</tr>
							</c:forEach>
						...
						<tfoot id='footer'>
							<tr>
								<td colspan='6'><c:forEach begin="1" end="${totalPage}"
										var="page">
										<c:choose>
								...
								<div class="social-links">
									<ul class="d-flex list-unstyled">
										<li><a href="<%=project%>admin/dashboard.do"> 관리자 페이지
											...
											<h5>[ ${ sessionScope.logname } ] 님, 로그인.</h5> <br />
