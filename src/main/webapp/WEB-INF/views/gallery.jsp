...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
	href="<%=project%>resources/css/jquery.fancybox.css">
...
<body>
									...
									<div class="item active">
										<div class="row">
											...
											<div class="col-xs-3 col-md-3">
												<div class="thumbnail site">
													<a class="fancybox" rel="gallery1"
														href="<%=project%>resources/images/gallery/1.jpg"><img
														src="<%=project%>resources/images/gallery/1.jpg" alt="..."></a>
											...
											<div class="col-xs-3 col-md-3">
												<div class="thumbnail site">
													<a class="fancybox" rel="gallery1"
														href="<%=project%>resources/images/gallery/2.jpg"><img
														src="<%=project%>resources/images/gallery/2.jpg" alt="..."></a>
													<div class="caption"></div>
												</div>
											</div>
											<div class="col-xs-3 col-md-3">
												<div class="thumbnail site">
													<a class="fancybox" rel="gallery1"
														href="<%=project%>resources/images/gallery/3.jpg"><img
														src="<%=project%>resources/images/gallery/3.jpg" alt="..."></a>
													<div class="caption"></div>
												</div>
											</div>
											<div class="col-xs-3 col-md-3">
												<div class="thumbnail site">
													<a class="fancybox" rel="gallery1"
														href="<%=project%>resources/images/gallery/4.jpg"><img
														src="<%=project%>resources/images/gallery/4.jpg" alt="..."></a>
													<div class="caption"></div>
												</div>
											</div>
										</div>
										...
										<div class="item">
											<div class="row">
												...
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/5.jpg"> <img
															src="<%=project%>resources/images/gallery/5.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/6.jpg"> <img
															src="<%=project%>resources/images/gallery/6.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/7.jpg"> <img
															src="<%=project%>resources/images/gallery/7.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/8.jpg"><img
															src="<%=project%>resources/images/gallery/8.jpg" alt="..."></a>
														<div class="caption"></div>
													</div>
												</div>
											</div>
										...
										<div class="item">
											<div class="row">
												...
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/9.jpg"> <img
															src="<%=project%>resources/images/gallery/9.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/10.jpg"> <img
															src="<%=project%>resources/images/gallery/10.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/11.jpg"> <img
															src="<%=project%>resources/images/gallery/11.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/12.jpg"><img
															src="<%=project%>resources/images/gallery/12.jpg" alt="..."></a>
														<div class="caption"></div>
													</div>
												</div>
											</div>
										...
										<div class="item">
											<div class="row">
												...
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/13.jpg"> <img
															src="<%=project%>resources/images/gallery/13.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/14.jpg"> <img
															src="<%=project%>resources/images/gallery/14.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/15.jpg"> <img
															src="<%=project%>resources/images/gallery/15.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/16.jpg"><img
															src="<%=project%>resources/images/gallery/16.jpg" alt="..."></a>
														<div class="caption"></div>
													</div>
												</div>
											</div>
										...
										<div class="item">
											<div class="row">
												...
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/17.jpg"> <img
															src="<%=project%>resources/images/gallery/17.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/18.jpg"> <img
															src="<%=project%>resources/images/gallery/18.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/19.jpg"> <img
															src="<%=project%>resources/images/gallery/19.jpg" alt="...">
														</a>
														<div class="caption"></div>
													</div>
												</div>
												<div class="col-xs-3 col-md-3">
													<div class="thumbnail site">
														<a class="fancybox" rel="gallery1"
															href="<%=project%>resources/images/gallery/20.jpg"><img
															src="<%=project%>resources/images/gallery/20.jpg" alt="..."></a>
														<div class="caption"></div>
													</div>
												</div>
											</div>
 ...
 <div class="col-lg-3 col-sm-6 pb-3" data-aos="fade" data-aos-easing="ease-in" data-aos-duration="1600" data-aos-once="true">
	...
	<script type="text/javascript" src="<%=project%>resources/js/animatescroll.min.js"></script>
	<script type="text/javascript" src="<%=project%>resources/js/simpleparallax.js"></script>
	<script type="text/javascript" src="<%=project%>resources/js/waypoints.min.js"></script>
	<script type="text/javascript" src="<%=project%>resources/js/jquery.fancybox.js"></script>
	<script type="text/javascript" src="<%=project%>resources/js/jquery.fancybox.pack.js"></script>
	<script>
