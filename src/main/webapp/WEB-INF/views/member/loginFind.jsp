  ...
  <head>
    ...
    <script>
        ...
        function idfind(){
            ...
            $.ajax({
                type : "POST",
                url : "<%=project%>member/idfind.do",
                data : param,
                success : function(result){
                	$('#idFindEmail').val("")
                	$('#idFindTel').val("")
                	$('#idFindName').val("")
                    $('#findIdResult').val(result);
                    $('.messageboxidfind').empty();
                },
                error : function(err){
                	$('#idFindEmail').val("")
                	$('#idFindTel').val("")
                	$('#idFindName').val("")
                	$('#findIdResult').val("")
                	$('.messageboxidfind').text("입력하신 정보와 일치하는 회원이 없습니다.")
                }
            });
    }
    ...
    function passfind(){
        ...
        $.ajax({
            type : "POST",
            url : "<%=project%>member/passfind.do",
            data : param,
            success : function(result){
            	if (result == "success") {
                    ...
                    var newForm = `
                        ...
                        <label for="sign-in" style="font-size:2vw">비밀번호 변경</label>
                   		 </div>
                    
                    	<form name="frm" id='frm' method="post" action="changepass.do">
                        
                    	<div class="form-group py-3">
                        <label for="verificationCode">이메일로 전송된 인증번호</label>
                        <br/>
                        <br/>
                        <input type="text" minlength="12" id="verificationCode" name="verificationCode" class="w-100" required>
                        </div>
                        ...
                        <label for="newPassword">새로운 비밀번호</label>
                            <br/>
                            <br/>
                         <input type="password" minlength="8" id="newPassword" name="pass" class="w-100" required><div class= 'messageboxPass warnBox'></div>
                        </div>
                        <div class="form-group py-3">
                            <label for="confirmPassword">비밀번호 확인</label>
                            <br/>
                            <br/>
                            <input type="password" minlength="8" id="confirmPassword" name="confirmpass" class="w-100" required><div class= 'messageboxPasscheck warnBox'></div>
                        </div>
                        <br/>
                        <input type="submit" name="submit" class="btn btn-dark w-100 my-3" value='비밀번호 변경'>
                        </form>
                    `;

                    $("#nav-pass").append(newForm);
                	...
                	$('#passFindTel').val("")
                	$('#passFindName').val("")
                    $('.messageboxpassfind').text("입력하신 정보와 일치하는 회원이 없습니다.")
                }
...
<section class="login-tabs padding-large">
            ...
            <div class="tabs-listing">
                <div class="" id="nav-tabContent">
                    <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel"
                        ...
                        <div class="form-group py-3">
                            <label for="sign-in" style="font-size:2vw">아이디 찾기</label>
                        </div>
                        <div class="form-group py-3">
                            <label for="sign-in">이메일</label>
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="idFindEmail" name="userEmail" placeholder="이메일을 입력해주세요" class="w-100"
                                   required>
                        </div>
                        <br/>
                        <div class="form-group py-3">
                            <label for="sign-in">전화번호</label>
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="idFindTel" name="userTel" placeholder="전화번호를 입력해주세요" class="w-100"
                                   required>
                        </div>
                        <br/>
                        <div class="form-group py-3">
                            <label for="sign-in">이름</label>
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="idFindName" name="userName" placeholder="이름을 입력해주세요" class="w-100"
                                   required>
                        </div>
                        <br/>
                        <div class="form-group py-3">
                            <label for="sign-in">아이디출력</label>
                            <br/>
                            <br/>
                            <input type="text" minlength="2" name="idFindId" placeholder="" class="w-100" value=""
                                   required disabled id="findIdResult">
                        </div>
						<div class= 'messageboxidfind warnBox'></div>
                        <button type="button" onclick="idfind()" name="submit" class="btn btn-dark w-100 my-3">아이디찾기</button>
                        <br/>
                        <br/>
                    </div>
                ...
                <div class="passfind" id="nav-tabContent">
                    <div class="tab-pane fade active show" id="nav-pass" role="tabpanel"
                         aria-labelledby="nav-sign-in-tab">
                         
                         
                         <div class="form-group py-3">
                            <label for="sign-in" style="font-size:2vw">비밀번호 찾기</label>
                        </div>
                        <div class="form-group py-3">
                            <label for="sign-in">아이디</label>
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="passFindId" name="userid" placeholder="아이디를 입력해주세요" class="w-100"
                                   required>
                        </div>
                        <div class="form-group py-3">
                            <label for="sign-in">이메일</label>
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="passFindEmail" name="userEmail" placeholder="이메일을 입력해주세요" class="w-100"
                                   required>
                        </div>
                        <br/>
                        <div class="form-group py-3">
                            ...
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="passFindTel" name="userTel" placeholder="전화번호를 입력해주세요" class="w-100"
                                   required>
                        </div>
                        <br/>
                        <div class="form-group py-3">
                            ...
                            <br/>
                            <br/>
                            <input type="text" minlength="2" id="passFindName" name="userName" placeholder="이름을 입력해주세요" class="w-100"
                                  required>
                        </div>
                        <br/>
						<div class= 'messageboxpassfind warnBox'></div>
                        <button type="button" onclick="passfind()" name="submit" class="btn btn-dark w-100 my-3">비밀번호 변경</button>

                    </div>

            </div>
             <button type="submit" name="submit" onclick="location.href='login.do'" class="btn btn-primary w-100 my-3">로그인으로 돌아가기</button>
        </div>
    </div>
    </div>
    </div>
	...
	if (errorMessage === 'incorrectVerificationCode' && verificationCode) {
	...
	function validatePassword() {
  	...
  	function confirm(){
        ...
        var passcheck = $('#confirmPassword').val();
  	
  		if(pass != passcheck) $('.messageboxPasscheck').text('비밀번호가 일치하지않습니다');
  		else $('.messageboxPasscheck').text("");
  	}
